...
\CTEXsetup[name={\hspace{0em}}]{subsection}
...
\newcommand{\TitleCHS}{Thesis Title} %中文标题

\newcommand{\TitleENG}{Thesis Title} %英文标题
...
% 2013年度高校教师在职攻读硕士学位论文
    % \parbox[t][4cm][c]{\textwidth}{\textbf{2018届本科生学士学位论文 }  \hfill 学校代码:~10269\hspace{3em}
    % \\ \mbox{~~~~} }

  % \setlength\parindent{0pt} 
  %   \parbox[t][4cm][t]{\textwidth}{\textbf{\Large{2018届本科生学士学位论文}}  \hfill \Large{学校代码:~10269}} 

  %   \parbox[t][5cm][t]{\textwidth}{
  %   \begin{center}
  %   \includegraphics[height=4.5cm]{figures/ECNU.png}
  %   \end{center} }

  %   \parbox[t][5.5cm][t]{\textwidth}{\Huge
  %   \begin{center} {\bf \bf \@ctitle } 
  %   \end{center} }
...
% type2
\setlength\parindent{0pt} 
\parbox[t][2cm][t]{\textwidth}{\textbf{\Large{2018届本科生学士学位论文}}  \hfill \Large{学校代码:~\underline{10269}}} 
